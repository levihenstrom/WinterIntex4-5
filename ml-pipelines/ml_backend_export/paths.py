...
All paths resolve from the **repository root** (parent of ``ml-pipelines/``), unless
...
def _repo_root() -> Path:
    ...
    # ml-pipelines/ml_backend_export/paths.py → repo root
    return Path(__file__).resolve().parent.parent.parent


REPO_ROOT: Path = _repo_root()
ML_PIPELINE_ROOT: Path = REPO_ROOT / "ml-pipelines"
