...
From **`WinterIntex4-5/ml_pipeline`** (same as other pipelines):

```bash
cd WinterIntex4-5/ml_pipeline
...
Or open `reintegration_effectiveness.ipynb` with Jupyter (cwd: `ml_pipeline/` or repo root).
